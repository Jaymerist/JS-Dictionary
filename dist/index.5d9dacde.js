...
const addWord = async ()=>{
    ...
    try {
        let wordObject = (0, _wordItemJs.createWordItem)(await (0, _dictionaryJs.getWord)(wordSearch));
...
},{"bootstrap/dist/css/bootstrap.css":"jJvnD","./dom/word-item.js":"knX6L","./api/dictionary.js":"bzxk5"}],"jJvnD":[function() {},{}],"knX6L":[function(require,module,exports) {
/*
HTML Structure 
...
},{}],"bzxk5":[function(require,module,exports) {
...
const getWord = async (word)=>{
    let wordObjects = [];
    const response = await fetch(`${DATA_URL}${word}`, {
        mehtod: "GET"
    });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jy52z","1Z4Rq"], "1Z4Rq", "parcelRequire6cbc")
